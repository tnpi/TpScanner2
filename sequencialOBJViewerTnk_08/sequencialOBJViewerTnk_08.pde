...
void fileSelected(File selection) {
  ...
  if (selection == null) {
    ...
    // User selected /Volumes/Transcend32/0123_2/artdkt_structure3d/8
  }
  ...
  for(int i=0; i<viewObjNum-2; i++) {
    ...
    modelList[i] = new OBJModel(this, selection.getAbsolutePath() + "/mesh_" + (i+200) + ".obj", "relative", TRIANGLES);
