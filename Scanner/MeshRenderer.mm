...
void MeshRenderer::uploadMesh (STMesh* mesh)
{
    ...
    if (d->hasTexture) {
        ...
        //  NSLog(@"MeshRenderer uploadMesh uploadTexture");
    }

    //  NSLog(@"MeshRenderer uploadMesh for loop start");

    for (int meshIndex = 0; meshIndex < numUploads; ++meshIndex)
    {
        //  NSLog(@"MeshRenderer uploadMesh loop first line");
        ...
        if (d->hasPerVertexNormals)
        {
            ...
            //  NSLog(@"MeshRenderer uploadMesh hasPerVertexNormals pass");
        ...
        if (d->hasPerVertexColor)
        {
            ...
            //  NSLog(@"MeshRenderer uploadMesh hasPerVertexColor pass");
        }
        ...
        if (d->hasPerVertexUV)
        {
            ...
            //  NSLog(@"MeshRenderer uploadMesh hasPerVertexUV pass");
        }
        ...
        //  NSLog(@"MeshRenderer uploadMesh loop end line");

    }
    //  NSLog(@"MeshRenderer uploadMesh for loop end");
